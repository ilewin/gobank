...
SELECT id, owner, balance, currency, created_at FROM accounts WHERE owner = $1 ORDER BY created_at DESC
`
...
SELECT id, owner, balance, currency, created_at FROM accounts WHERE owner = $1 ORDER BY created_at DESC LIMIT $2 OFFSET $3
`
